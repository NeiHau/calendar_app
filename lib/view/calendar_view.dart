...
class CustomCalendarState extends State<CustomCalendar>
  ...
  late double collapsedHeightFactor;

  /// The y coordinate of the active week row
  late double activeRowYPosition;
  ...
  late ValueChanged<bool> onExpansionChanged;

  /// Color tween for -> and <- icons
  final Animatable<Color> _arrowColorTween =
      Animatable(begin: const Color(0x00FFA68A), end: const Color(0xffFFA68A));

  /// Color tween for expand_less icon
  final Animatable<Color> _monthColorTween =
  ...
  List<Widget> returnRowList(DateTime start) {
    ...
    for (int i = 0; i < rowValueList.length; i++) {
      ...
      Widget temp = Padding(
          ...
          padding: const EdgeInsets.only(bottom: 12, left: 36, right: 36),
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            crossAxisAlignment: CrossAxisAlignment.center,
            children: itemList,
